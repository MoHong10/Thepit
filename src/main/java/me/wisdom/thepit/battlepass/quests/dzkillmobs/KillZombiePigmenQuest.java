...
public class KillZombiePigmenQuest extends PassQuest {
    ...
    public KillZombiePigmenQuest() {
        super("&c&l僵尸猪人杀手", "killzombiepigmen", QuestType.WEEKLY);
    ...
    public ItemStack getDisplayStack(PitPlayer pitPlayer, QuestLevel questLevel, double progress) {
        ItemStack itemStack = new AItemStackBuilder(Material.PORK)
                ...
                .setLore(new ALoreBuilder(
                        "&7击杀 &c" + Formatter.formatLarge(questLevel.getRequirement(pitPlayer)) + " &7僵尸猪人",
                        "",
                        ...
                        "&7奖: &3" + questLevel.rewardPoints + " &7任务点"
                ))
                .getItemStack();
        return itemStack;
    }
