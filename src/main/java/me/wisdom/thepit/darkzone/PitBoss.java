...
public abstract class PitBoss {
    ...
    private long lastRoutineExecuteTick = Thepit.currentTick;
    ...
    public void spawn() {
        ...
        routineRunnable = new BukkitRunnable() {
            ...
            public void run() {
                ...
                if(lastRoutineExecuteTick + routineAbilityCooldownTicks > Thepit.currentTick) return;
                ...
                lastRoutineExecuteTick = Thepit.currentTick;
