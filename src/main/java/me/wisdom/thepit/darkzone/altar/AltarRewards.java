...
import me.wisdom.thepit.darkzone.altar.pedestals.TurmoilPedestal;
import me.wisdom.thepit.darkzone.altar.pedestals.WealthPedestal;
...
public class AltarRewards {
    ...
    public static final int ROLLS = Thepit.isDev() ? 10_000 : 1;
