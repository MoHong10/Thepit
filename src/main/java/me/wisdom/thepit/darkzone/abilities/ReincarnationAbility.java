...
import me.wisdom.thepit.cosmetics.particles.CloudParticle;
...
public class ReincarnationAbility extends PitBossAbility {
    ...
    public void activate() {
        ...
        }.runTaskTimer(Thepit.INSTANCE, 20, 1);
        ...
        }.runTaskLater(Thepit.INSTANCE, 80);
    }
    ...
    public void createRays(Location center) {
        ...
        for(int i = 0; i < rays; i++) {
            ...
            for(int j = 0; j < 75; j++) {
                ...
                }.runTaskTimer(Thepit.INSTANCE, 75 - j, 5);
            }
        }
    }
}
