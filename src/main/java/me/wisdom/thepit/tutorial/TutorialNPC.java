...
public class TutorialNPC implements Listener {
    public static final String NPC_SKIN_NAME = "黑暗区教程";
    ...
    public void create() {
        ...
        } else throw new RuntimeException("找不到教程NPC的皮肤");
    }
            ...
            runningTasks.add(new BukkitRunnable() {
                ...
                public void cancel() {
                    ...
                    if(runningTasks.size() > 0) {
                        runningTasks.get(0).runTaskTimer(Thepit.INSTANCE, 0, 10);
                    }
                }
            });
    ...
    public void onNPCClick(NPCRightClickEvent event) {
        ...
        else tutorial.sendMessage("&c请从你的背包中移除一些物品以继续", 0);
    }
    ...
    public void setCheckpoint(NPCCheckpoint checkpoint) {
        if(!checkpoint.canEngage(tutorial) || TaintedWell.playerItems.containsKey(tutorial.pitPlayer.player)) {
            tutorial.sendMessage("&c请从你的背包中移除一些物品以继续", 0);
            return;
        }
