...
import me.wisdom.thepit.misc.math.Point2D;
import me.wisdom.thepit.misc.math.Polygon2D;
    ...
    public void onUse(SpellUseEvent event) {
        ...
        for(int i = 0; i < EFFECT_SEGMENTS; i++) {
            ...
            for(Block block : new ArrayList<>(validBlocks)) {
                ...
                }.runTaskLater(Thepit.INSTANCE, getRunnableDelay(segmentNum));
            }
        ...
        }.runTaskTimer(Thepit.INSTANCE, 20 * 4, 2L);
