...
import me.wisdom.thepit.help.Summarizable;
import me.wisdom.thepit.controllers.Cooldown;
import me.wisdom.thepit.enchants.overworld.Regularity;
import me.wisdom.thepit.enums.ApplyType;
import me.wisdom.thepit.enums.EnchantRarity;
import me.wisdom.thepit.serverstatistics.StatisticCategory;
...
public abstract class PitEnchant implements Listener, Summarizable {
    ...
    public boolean isEnabled() {
        if(Thepit.status == Thepit.ServerStatus.STANDALONE) return true;
        if(isTainted) {
            return Thepit.getStatus() == Thepit.ServerStatus.DARKZONE;
        } else {
            return Thepit.getStatus() == Thepit.ServerStatus.OVERWORLD || applyType == ApplyType.BOWS;
        }
    }
