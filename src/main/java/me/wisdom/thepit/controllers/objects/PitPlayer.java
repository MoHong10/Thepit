...
import me.wisdom.thepitapi.data.APlayer;
import me.wisdom.thepitapi.data.APlayerData;
...
import me.wisdom.thepit.darkzone.progression.skillbranches.ManaBranch;
...
import me.wisdom.thepit.battlepass.quests.ReachKillstreakQuest;
...
import me.wisdom.thepit.enchants.overworld.GottaGoFast;
import me.wisdom.thepit.enchants.overworld.Hearts;
import me.wisdom.thepit.enchants.tainted.chestplate.Sonic;
import me.wisdom.thepit.enchants.tainted.uncommon.Tanky;
import me.wisdom.thepit.enums.AChatColor;
import me.wisdom.thepit.enums.DeathCry;
import me.wisdom.thepit.enums.KillEffect;
import me.wisdom.thepit.events.HealEvent;
import me.wisdom.thepit.events.IncrementKillsEvent;
import me.wisdom.thepit.inventories.ChatColorPanel;
import me.wisdom.thepit.killstreaks.Limiter;
import me.wisdom.thepit.killstreaks.Monster;
...
import me.wisdom.thepit.settings.scoreboard.ScoreboardData;
...
import me.wisdom.thepit.tutorial.OverworldTutorial;
import me.wisdom.thepit.tutorial.TutorialData;
...
public class PitPlayer {
    ...
    public double lastVersion = Thepit.VERSION;
    ...
    public void save(boolean finalSave, BukkitRunnable callback, boolean itemData) throws ExecutionException, InterruptedException {
        ...
        if(finalSave && callback != null) {
            FirestoreManager.FIRESTORE.collection(FirestoreManager.PLAYERDATA_COLLECTION).document(uuid.toString())
                    .set(this).addListener(callback, command -> callback.runTask(Thepit.INSTANCE));
