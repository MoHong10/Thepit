...
import me.wisdom.thepit.enchants.tainted.uncommon.Fortify;
import me.wisdom.thepit.enchants.tainted.uncommon.Mechanic;
...
public class Shield {
    ...
    public boolean isActive() {
        if(!isUnlocked() || Thepit.status.isOverworld()) return false;
        return isActive;
    }
