...
//					hitTarget.damage(damage, hopper);
    ...
    public void setBlocking(boolean blocking) {
        for(Player onlinePlayer : Bukkit.getOnlinePlayers()) {
            ...
            PacketContainer packet = Thepit.PROTOCOL_MANAGER.createPacket(PacketType.Play.Server.ENTITY_METADATA);
            ...
            try {
                Thepit.PROTOCOL_MANAGER.sendServerPacket(onlinePlayer, packet);
            } catch(Exception e) {
                e.printStackTrace();
            }
        }
