...
import me.wisdom.pitguilds.BuffManager;
import me.wisdom.pitguilds.Guild;
import me.wisdom.pitguilds.GuildBuff;
import me.wisdom.pitguilds.GuildManager;
import me.wisdom.pitguilds.events.GuildWithdrawalEvent;
import me.wisdom.thepit.Thepit;
import me.wisdom.thepit.battlepass.quests.EarnGuildReputationQuest;
...
public class GuildIntegrationManager implements Listener {
    ...
    public void onWithdrawal(GuildWithdrawalEvent event) {
        ...
        if(pitPlayer.level < levelRequired) {
            ...
            AOutput.error(event.getPlayer(), "&c&l错误!&7 你必须达到等级 " + levelRequired + " 才能进行提现");
        }
    }
