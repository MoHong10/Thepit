...
import me.wisdom.thepit.darkzone.progression.skillbranches.DefenceBranch;
import me.wisdom.thepit.enchants.overworld.Regularity;
import me.wisdom.thepit.enchants.overworld.Singularity;
import me.wisdom.thepit.enchants.overworld.Telebow;
import me.wisdom.thepit.enchants.tainted.chestplate.Persephone;
import me.wisdom.thepit.enchants.tainted.uncommon.ShieldBuster;
...
import me.wisdom.thepit.events.WrapperEntityDamageEvent;
import me.wisdom.thepit.misc.ArmorReduction;
import me.wisdom.thepit.misc.Misc;
import me.wisdom.thepit.misc.Sounds;
import me.wisdom.thepit.upgrades.KillSteal;
...
//		New player defence
        if(Thepit.status.isOverworld() && attackEvent.isDefenderRealPlayer() && attackEvent.isAttackerRealPlayer() &&
...
//				loseLives(dead, killer);
        ...
        if(deadMob != null) {
        ...
        } else if(killType != KillType.DEATH && Thepit.status.isOverworld() && pitKiller != null) {
            ...
            String hoverText = difference > 0 ? "&7前往 &5黑暗区 &7以移除此减益" : "&7&5黑暗区 &7因你的牺牲而奖励你";
            ...
            kill = PlaceholderAPI.setPlaceholders(killEvent.getDeadPlayer(), "&a&l击杀!&7 在 %luckperms_prefix%" +
        ...
        if(Thepit.status.isDarkzone() && deadIsRealPlayer){
            int finalSouls = killEvent.getFinalSouls();
