package me.wisdom.thepit.logging;
...
public class LogManager implements Listener {
    ...
    public static void sendLogMessage(LogType logType, String message) {
        OffsetDateTime date = OffsetDateTime.now(Thepit.TIME_ZONE);
        DateTimeFormatter dateFormat = DateTimeFormatter.ofPattern("HH:mm:ss");

        PluginMessage pluginMessage = new PluginMessage();
        pluginMessage.writeString("LOG").writeString(logType.toString()).writeString(Thepit.serverName);
        pluginMessage.writeString("[" + dateFormat.format(date) + "][" + Thepit.serverName + "][" + logType + "]: " + message);
