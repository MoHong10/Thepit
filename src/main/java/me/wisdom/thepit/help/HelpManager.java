...
import me.wisdom.thepit.sql.Constraint;
import me.wisdom.thepit.sql.SQLTable;
import me.wisdom.thepit.sql.TableManager;
import me.wisdom.thepit.sql.Value;
...
//							.setEntryFulfillment(createFulfillment(helpPage.getEntryFulfillment()))
    ...
    private static void setupEnv() {
        ...
        newEnvFields.put("GOOGLE_APPLICATION_CREDENTIALS", Thepit.INSTANCE.getDataFolder() + "/google-key.json");
        try {
